...
import { bookAppointment, getSentRequests, getDoctorDetails, removeDoctorDetails } from '../../../actions/userActions'
...
class DoctorDetailsScreen extends Component {
    ...
    componentWillUnmount() {
        this.props.removeDoctorDetails()
                        ...
                        <View style={styles.container}>
                            ...
                            <View style={styles.options} >
                                <View style={{ flexDirection: 'row', }}>
                                    ...
                                    <View style={{ width: '85%', justifyContent: 'center', flexDirection: 'row', flexWrap: 'wrap' }} >
                                        {this.props.doctorDetails.speciality.map((data, key) => {
                                            return (
                                                <Text key={key} style={{ color: 'rgb(3,155,229)', marginRight: 10 }} >
                                                    {data}
                                                </Text>
                                            )
                                        })}
...
const mapDispatchToProps = (dispatch) => {
    return bindActionCreators({
        bookAppointment, getSentRequests, getDoctorDetails, removeDoctorDetails, removeDoctorDetails
    }, dispatch)
}
